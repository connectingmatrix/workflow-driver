...
- Path: `packages/apps/workflow/src/services/workflow/read`
...
- Functions (all):
  - `createExecutionRecord` (L72-L72, arrow)
  - `listActiveExecutionRows` (L98-L98, arrow)
  - `listLatestExecutionRows` (L100-L100, arrow)
  - `listWorkflowVersionsRows` (L241-L241, arrow)
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L72-L72`: Implements `createExecutionRecord` for this module use case.
  - `L98-L98`: Implements `listActiveExecutionRows` for this module use case.
  - `L100-L100`: Implements `listLatestExecutionRows` for this module use case.
  - `L241-L241`: Implements `listWorkflowVersionsRows` for this module use case.
