...
- Path: `packages/apps/workflow/src/services/workflow/contracts`
...
- Functions (all):
  - `canExecuteOrganizationWorkflow` (L33-L33, arrow)
  - `workflowEditorUrl` (L35-L35, arrow)
  - `requireWorkflowExecutionRecord` (L51-L51, arrow)
  - `createWorkflowReferenceRunner` (L75-L75, arrow)
  - `createWorkflowReferenceHostContext` (L94-L94, arrow)
  - `backendPayload` (L186-L186, arrow)
- Exports:
  - `createWorkflowReferenceHostContext` (L94)
- Key snippets and use-case mapping:
  - `L33-L33`: Implements `canExecuteOrganizationWorkflow` for this module use case.
  - `L35-L35`: Implements `workflowEditorUrl` for this module use case.
  - `L51-L51`: Implements `requireWorkflowExecutionRecord` for this module use case.
  - `L75-L75`: Implements `createWorkflowReferenceRunner` for this module use case.
  - `L94-L94`: Implements `createWorkflowReferenceHostContext` for this module use case.
  - `L186-L186`: Implements `backendPayload` for this module use case.
### `types.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L130`: File-level constants/types behavior.
