...
export function createConnectingmatrixWorkflowsStubLauncher(context: RequestContext = {}): PackageLauncherPanel {
  return {
    ...
    actions: [
      { name: 'openDesignerStub', label: 'openDesignerStub', method: 'LOCAL' as const, description: 'Run openDesignerStub demo action' },
      { name: 'execute', label: 'execute', method: 'LOCAL' as const, description: 'Run execute demo action' },
      { name: 'validate', label: 'validate', method: 'LOCAL' as const, description: 'Run validate demo action' },
      { name: 'publishVersion', label: 'publishVersion', method: 'LOCAL' as const, description: 'Run publishVersion demo action' }
    ],
...
export const Launcher = { open: createConnectingmatrixWorkflowsStubLauncher, mode: 'stub' as const };
