...
export interface GraphQLPackage {
  ...
  slashCommands?: Array<{ command: string; owner?: string; description?: string; handler: (args: string[], context: RequestContext, raw?: string) => unknown | Promise<unknown> }>;
...
export interface PackageLauncherPanel {
  ...
  owns?: { ui?: string[]; backend?: string[]; entity?: string[]; migrations?: string[] };
