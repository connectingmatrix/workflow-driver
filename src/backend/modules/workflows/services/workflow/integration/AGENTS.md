...
- Path: `packages/apps/workflow/src/services/workflow/integration`
...
- Functions (all):
  - `getAdminSupabase` (L21-L21, arrow)
  - `normalizeFilterText` (L66-L66, function)
  - `normalizeNullableId` (L72-L72, function)
  - `normalizeWorkflowAssignmentMetadata` (L76-L76, function)
  - `hasEqFilter` (L81-L81, function)
  - `hasInFilter` (L85-L85, function)
  - `getEqFilterValue` (L89-L89, function)
  - `getInFilterValues` (L96-L96, function)
  - `getNullFilterValue` (L107-L107, function)
  - `matchesWorkflowAssignmentFilterValue` (L116-L116, function)
  - `filterWorkflowAssignmentRows` (L132-L132, function)
  - `normalizeAssignmentSlot` (L144-L144, function)
  - `readWorkflowOrganizationId` (L164-L164, function)
  - `preparePublishedWorkflowUpdate` (L170-L170, function)
  - `upsertWorkflowAssignmentSlot` (L212-L212, function)
  - `createAiWorkflowsCollectionData` (L239-L239, function)
  - `updateAiWorkflowsCollectionData` (L283-L283, function)
  - `createAiWorkflowAssignmentsCollectionData` (L327-L327, function)
  - `updateAiWorkflowAssignmentsCollectionData` (L373-L373, function)
  - `deleteAiWorkflowAssignmentsCollectionData` (L425-L425, function)
- Exports:
  - `createAiWorkflowsCollectionData` (L239)
  - `updateAiWorkflowsCollectionData` (L283)
  - `createAiWorkflowAssignmentsCollectionData` (L327)
  - `updateAiWorkflowAssignmentsCollectionData` (L373)
  - `deleteAiWorkflowAssignmentsCollectionData` (L425)
- Key snippets and use-case mapping:
  - `L21-L21`: Implements `getAdminSupabase` for this module use case.
  - `L66-L66`: Implements `normalizeFilterText` for this module use case.
  - `L72-L72`: Implements `normalizeNullableId` for this module use case.
  - `L76-L76`: Implements `normalizeWorkflowAssignmentMetadata` for this module use case.
  - `L81-L81`: Implements `hasEqFilter` for this module use case.
  - `L85-L85`: Implements `hasInFilter` for this module use case.
  - `L89-L89`: Implements `getEqFilterValue` for this module use case.
  - `L96-L96`: Implements `getInFilterValues` for this module use case.
  - `L107-L107`: Implements `getNullFilterValue` for this module use case.
  - `L116-L116`: Implements `matchesWorkflowAssignmentFilterValue` for this module use case.
  - `L132-L132`: Implements `filterWorkflowAssignmentRows` for this module use case.
  - `L144-L144`: Implements `normalizeAssignmentSlot` for this module use case.
  - `L164-L164`: Implements `readWorkflowOrganizationId` for this module use case.
  - `L170-L170`: Implements `preparePublishedWorkflowUpdate` for this module use case.
  - `L212-L212`: Implements `upsertWorkflowAssignmentSlot` for this module use case.
  - `L239-L239`: Implements `createAiWorkflowsCollectionData` for this module use case.
  - `L283-L283`: Implements `updateAiWorkflowsCollectionData` for this module use case.
  - `L327-L327`: Implements `createAiWorkflowAssignmentsCollectionData` for this module use case.
  - `L373-L373`: Implements `updateAiWorkflowAssignmentsCollectionData` for this module use case.
  - `L425-L425`: Implements `deleteAiWorkflowAssignmentsCollectionData` for this module use case.
### `workflowExecutorChatAdapterBindings.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `executeWorkflowChatAdapterAction` (L1-L1, arrow)
- Exports:
  - `executeWorkflowChatAdapterAction` (L1)
- Key snippets and use-case mapping:
  - `L1-L1`: Implements `executeWorkflowChatAdapterAction` for this module use case.
